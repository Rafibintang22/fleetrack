        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              class={`w-full ${style.input} border rounded-lg transition-colors ${isEditing()
                ? `focus:outline-none focus:ring-2  focus:border-transparent ${errors().Nama
          ...
          <div class="md:col-span-2">
            ...
            <input
              ...
              disabled={!isEditing()}
              class={`w-full ${style.input} border rounded-lg transition-colors ${isEditing()
                ? `focus:outline-none focus:ring-2  focus:border-transparent ${errors().Email
                  ? "border-red-500 bg-red-50"
                  : "border-gray-300"
                }`
                : "border-gray-300 bg-gray-50"
          ...
          <div class="md:col-span-2">
            ...
            <select
              ...
              disabled={!isEditing()}
              class={`w-full ${style.input} border rounded-lg transition-colors ${isEditing()
                ? `focus:outline-none focus:ring-2  focus:border-transparent ${errors().Peran
                  ? "border-red-500 bg-red-50"
                  : "border-gray-300"
                }`
                : "border-gray-300 bg-gray-50"
          ...
          <div class="md:col-span-2">
            ...
            <input
              ...
              disabled={!isEditing()}
              class={`w-full ${style.input} border rounded-lg transition-colors ${isEditing()
                ? `focus:outline-none focus:ring-2  focus:border-transparent ${errors().PasswordLama
                  ? "border-red-500 bg-red-50"
                  : "border-gray-300"
                }`
                : "border-gray-300 bg-gray-50"
          ...
          <div>
            ...
            <input
              ...
              disabled={!isEditing()}
              class={`w-full ${style.input} border rounded-lg transition-colors ${isEditing()
                ? `focus:outline-none focus:ring-2  focus:border-transparent ${errors().PasswordBaru
                  ? "border-red-500 bg-red-50"
                  : "border-gray-300"
                }`
                : "border-gray-300 bg-gray-50"
          ...
          <div>
            ...
            <input
              ...
              disabled={!isEditing()}
              class={`w-full ${style.input} border rounded-lg transition-colors ${isEditing()
                ? `focus:outline-none focus:ring-2  focus:border-transparent ${errors().KonfirmasiPassword
                  ? "border-red-500 bg-red-50"
                  : "border-gray-300"
                }`
                : "border-gray-300 bg-gray-50"
              ...
              {formData().Kendaraan.map((kendaraan, index) => (
                ...
                >
                  ...
                  <div class="mt-3 flex justify-between items-center">
                    <span
                      class={`px-2 py-1 text-xs rounded-full font-medium ${kendaraan.Status === "Aktif"
